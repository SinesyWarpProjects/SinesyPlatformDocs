...
## **Opening a detail form in a window, starting from a click in a row of a grid** <a href="#opendetailform" id="opendetailform"></a>
...
## **Opening a report in a window** <a href="#openreport" id="openreport"></a>
...
## **Choosing a photo from photo-library/take a photo and send it to the server** <a href="#sendingphototoserver" id="sendingphototoserver"></a>
...
## **Scanning a barcode using the camera** <a href="#scanningbarcode" id="scanningbarcode"></a>
