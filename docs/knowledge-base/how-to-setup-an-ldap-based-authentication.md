...
* account auth format - e.g. **\{u\}domain** or **\{SUB01.EMail\}** or **\{PARAM.ALTERNATIVE\_USERNAME\}** if you want use the username in PRM08\_USER\_PSSPORTS with PARAM\_ID='ALTERNATIVE\_USERNAME' (customization)
