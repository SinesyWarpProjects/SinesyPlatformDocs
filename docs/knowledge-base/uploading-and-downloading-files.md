...
uploadFile(
    ...
    19, // dirId
    function(args) \{
        var filename = args.filename; // Pay attention: it's "args.filename" in lowercase in this function!
        return true; // do not block file uploading!
    \}, // beforeUploadCallback
    function(args) \{
        var filename = args.fileName; // Pay attention: it's "args.fileName" in camelCase in this function!
    \}, // afterUploadCallback
    function(args) \{
...
<!-- Image not available: /broken/files/-M92VHk2WyICZzQYUUhs -->
