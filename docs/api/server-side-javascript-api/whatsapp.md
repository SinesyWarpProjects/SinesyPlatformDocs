...
\{% embed url="https://www.twilio.com/docs/whatsapp/tutorial/send-whatsapp-notification-messages-templates#whatsapp-message-templates-overview" %\}
...
\{% embed url="https://www.twilio.com/en-us/whatsapp/pricing" %\}
...
\{% embed url="https://www.twilio.com/docs/whatsapp/self-sign-up" %\}
...
\{% embed url="https://www.twilio.com/console/sms/whatsapp/sandbox" %\}
...
\{% embed url="https://www.twilio.com/docs/whatsapp/tutorial/connect-number-business-profile" %\}
