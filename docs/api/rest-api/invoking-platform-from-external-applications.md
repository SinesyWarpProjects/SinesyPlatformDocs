...
| enabled               | <p>boolean value used to download only an already uploaded file or to upload/download; <br/>true: upload button is enabled, false: upload button is disabled</p>                                                                                                                                                                                                                                                    |
| fileName              | file name to pre-set in the input field; this is helpful when the file has been already uploaded in the past and this popup window is used to preview/download it (or re-upload and replace the file)                                                                                                                                                                                                              |
| dirId                 | directory identifier, used to define where the file to upload will be saved (or when the already uploaded file has been saved, to retrieve it and show a preview or download it)                                                                                                                                                                                                                                   |
| beforeUploadCallback  | <p>optional javascript function, automatically invoked by Platform when pressing the Upload button; this function must have one argument, whose content is: </p><p>\{ filename: "...." \} </p><p>If the callback function would return false, the upload process is interrupted. </p><p>It is also possible to rename the file to upload, by replacing the value of the "filename" attribute passed by reference</p> |
| afterUploadCallback   | <p>optional javascript function, automatically invoked by Platform when pressing the Upload button and after a successful upload process;  this function must have one argument, whose content is: </p><p>\{</p><p>  success: true|false, </p><p>  message: "...", </p><p>  fileName: "...."</p><p>\}</p>                                                                                                            |
| errorOnUploadCallback | <p>optional javascript function, automatically invoked by Platform when pressing the Upload button in case the upload process failed;  this function must have one argument, whose content is: </p><p>\{</p><p>  error: "..."</p><p>\}</p>                                                                                                                                                                           |
| additionalSettings    | <p>optional javascript object; if not null, each attribute is passed forward to the server-side; built-in optional attributes are: <br/>\{ </p><p>  encriptAttachments: true|false, </p><p>  panelId: ... </p><p>\}</p>                                                                                                                                                                                               |
...
| Argument      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| uri           | <p>URL to invoke; in case of Platform it can be something like: contextPath+"/..."; </p><p>e.g. contextPath+"/executeJs?applicationId=...&#x26;actionId=... </p><p>e.g. contextPath+"/api?applicationId=...&#x26;cmd=... </p>                                                                                                                                                                                                                                             |
| method        | optional argument; if not specified, it is set to "GET"; it represents the HTTP method; allowed values: "GET"; "POST", "PUT", ...                                                                                                                                                                                                                                                                                                                                         |
| data          | optional argument; it represents the content to pass forward to the server, in the HTTP request body, always expressed as a String (e.g. a JSON string); this argument is ignored in case of GET based requests                                                                                                                                                                                                                                                           |
| mimeType      | optional argument; request content type (e.g. application/json)                                                                                                                                                                                                                                                                                                                                                                                                           |
| callback      | <p>optional argument; if specified, it is a javascript function automatically invoked by Platform at the end of a successful HTTP request; bear in mind that a "successful request" is a request whose HTTP response code is 200, i.e. a response whose JSON content is </p><p>\{ success: false, message: "..." \} </p><p>is still considered a "successful request" T</p><p>This function must have one argument, containing the response text, expressed as a String</p> |
| callbackError | <p>optional argument; if specified, it is a javascript function automatically invoked by Platform at the end of an HTTP request interrupted with errors, i.e. whose HTTP response code is NOT 200. </p><p>This function must have two arguments: statusText and status (a number)</p>                                                                                                                                                                                     |
