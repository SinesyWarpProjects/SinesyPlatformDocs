...
Through the following [**server-side**](/broken/pages/-M2cc7sye3nT7eVKHw_l) javascript function you can notify via push notification the mobile app.
...
Through the following [**server-side**](/broken/pages/-M2cc7sye3nT7eVKHw_l) javascript function you can notify via push notification **a specific device** where the  mobile app has been installed.
