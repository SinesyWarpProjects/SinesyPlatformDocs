...
| -------- | --------------------------- |
| callback | a string with callback name |
...
<table data-header-hidden><thead><tr><th width="386">Argument</th><th>Description</th></tr></thead><tbody><tr><td>Argument</td><td>Description</td></tr><tr><td>title</td><td>the title to set in the currently shown window</td></tr></tbody></table>
...
| Argument       | Description                                                                                                                  |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| forceFirstSync | boolean, _optional_. If true force sync like first installation                                                              |
| generateAll    | boolean, _optional_. If true download all data synchronous (makes sense only if I activate background sync via notification) |
...
## logger(logMessage) or log(logMessage) <a href="#logger" id="logger"></a>
