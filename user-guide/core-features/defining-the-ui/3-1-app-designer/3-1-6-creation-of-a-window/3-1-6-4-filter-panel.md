...
* **dynamicFilterValuesWidth** - this numeric property is not needed in most of the cases and it can be used in case you want to define a filter value input field width different from the default value (200 pixels)
