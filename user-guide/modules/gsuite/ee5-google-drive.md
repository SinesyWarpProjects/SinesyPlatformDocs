...
&#xNAN;_&#x52;eturn value_ - the Platform file representation (org.wag.valueobjects.java.File).
...
**fileId** – the id of the file\
&#xNAN;_&#x52;eturn value_ - a string containing the URL
...
**fileId** – the id of the file\
&#xNAN;_&#x52;eturn value_ - a list of the Platform representation of the version of a file (List)
...
&#xNAN;_&#x52;eturn value_ - the Platform file representation (org.wag.valueobjects.java.File) having the boolean flag "folder" with true value.
...
&#xNAN;_&#x52;eturn value_ - list of strings
...
**query** – an optional query to filter the search (see docs)\
**trashed** – true or false. Specify if extact also trashed files/folders.\
&#xNAN;_&#x52;eturn value_ - list of the Platform file representation (org.wag.valueobjects.java.File)
...
&#xNAN;_&#x52;eturn value_ - a String containing the property value.
