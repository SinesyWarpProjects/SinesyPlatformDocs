...
&#xNAN;_&#x52;eturn value_ - A string containing the signed URL.
...
**bucketName** – the name of the bucket which we want to operate on\
&#xNAN;_&#x52;eturn value_ - The file container representation (org.wag.valueobjects.java.FileContainer)
...
**bucketName** – the name of the bucket which we want to operate on\
&#xNAN;_&#x52;eturn value_ - true or false
...
&#xNAN;_&#x52;eturn value_ - the file representation (org.wag.valueobjects.java.File)
...
**bucketName** – the bucket of the object\
**objectName** – the object name, with full path\
&#xNAN;_&#x52;eturn value_ - A list of the file version representation objects (org.wag.valueobjects.java.FileVersion)
...
&#xNAN;_&#x52;eturn value_ - A list of the file representation objects (org.wag.valueobjects.java.File)
...
**prefix** – the prefix to filter the objects\
**delimiter** – the path delimiter\
&#xNAN;_&#x52;eturn value_ - A GooglePaginatedList (org.wag.valueobjects.java.GooglePaginatedList) of the file representation objects (org.wag.valueobjects.java.File)
