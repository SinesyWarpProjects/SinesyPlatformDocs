...
## showConfirmDialog(args,callbackSuccess(outcome),callbackCancel(outcome)) <a href="#showconfirmdialog" id="showconfirmdialog"></a>
...
## showListDialog(args,callbackSuccess(itemIndex),callbackCancel) <a href="#showlistdialog" id="showlistdialog"></a>
...
## openRemoteDocument(fileName,url) <a href="#openremotedocument" id="openremotedocument"></a>
