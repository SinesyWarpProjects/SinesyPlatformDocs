...
See [Quotas and limits](https://cloud.google.com/bigquery/quotas#dataset_limits) for more details.
...
See [Quotas and limits](https://cloud.google.com/bigquery/quotas#streaming_inserts) for more details.
...
Let's have a table having 3 fields: ITEM\_ID a text field used as a primary key, a QTY numeric field _and a_ datetime field LAST\_UPDATE used to store the most recent version of the ITEM\_ID.
