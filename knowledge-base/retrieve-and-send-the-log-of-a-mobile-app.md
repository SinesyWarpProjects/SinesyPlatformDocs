...
<div align="center"><img src=".gitbook/assets/image (14).png" alt="example of notification made by an app user"></div>

![example of automatic report on error](<.gitbook/assets/image (23).png>)
...
### Define an incoming webhook <a href="#define_an_incoming_webhook" id="define_an_incoming_webhook"></a>
